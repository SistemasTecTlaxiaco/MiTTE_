...
<head>
    ...
    <title></title>
    <link rel="icon" href="<?php echo constant('URL');?>img/favicon.png" sizes="32x32" type="image/png">
    <link rel="icon" href="<?php echo constant('URL');?>img/favicon.png" sizes="16x16" type="image/png">
